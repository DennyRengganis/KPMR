								...
								$.each(data,function(id,val){
									...
									if(val['status_now']=="FREE"){
										...
										$('.list_ruangan').append('<div class="col-4 col-s-4 center">'
											...
											+val['status_now']
											+'<br>'
											+'<form action="/bookingRoom" method="get" target="_self"><button type="submit" class="btn btn-primary">+Booking</button></form>'
											+'BOOK NOW'
											+'</div>'
											+'</div>');
									};
									...
									if(val['status_now']=="BOOKED"){
										...
										$('.list_ruangan').append('<div class="col-4 col-s-4 center">'
											...
											+val['status_now']
											+'<br>'
											+'<br><form action="/bookingRoom" method="get" target="_self"><button type="submit" class="btn btn-primary">+Schedule Meeting</button></form>'
											+'</div>'
											+'</div>');
									};
