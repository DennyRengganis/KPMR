...
<!-- 			<div class="row">
			...
			<div class="col-w-1 col-s-2 " >
				<br>
				<form action="/nambahGedung" method="get" target="_self">
								...
								$.each(data[1],function(key,val){
									...
									if(val['status_now']=="FREE"){
										...
										$('.list_ruangan').append('<div class="col-w-4 col-s-6 center">'
											...
											+val['status_now']
											+'<br>'
											+'<form action="/bookingRoom/'+val['id']+'" method="get" target="_self"><button type="submit" class="btn btn-primary">Edit Room</button></form>'
											+'BOOK NOW'
											+'</div>'
											+'</div>');
									};
									...
									if(val['status_now']=="BOOKED"){
										...
										$('.list_ruangan').append('<div class="col-w-4 col-s-6 center">'
											...
											+val['status_now']
											+'<br>'
											+'<br><form action="/bookingRoom/'+val['id']+'" method="get" target="_self"><button type="submit" class="btn btn-primary">Edit Room</button></form>'
											+'</div>'
